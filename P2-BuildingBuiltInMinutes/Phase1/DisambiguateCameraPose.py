...
def getCorrectPose(K, C_out: np.array, R_out: np.array, points1: np.array, points2):
    """
    ...
    return C_out[index, :].reshape(3, 1), R_out[index, :, :].reshape(3, 3), disambiguated_inliers
